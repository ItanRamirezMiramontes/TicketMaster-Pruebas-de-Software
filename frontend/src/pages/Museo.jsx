  ...
  useEffect(() => {
    const loadVenues = async () => {
      try {
        ...
        setError("Error al cargar museos disponibles");
      } finally {
        setLoading(false);
      }
    };
      ...
      <div className="rounded-3xl border border-slate-800 bg-slate-900/90 p-8 shadow-xl shadow-slate-950/40">
        <div className="flex items-center justify-between gap-4">
          <div>
            ...
            <p className="mt-2 text-slate-400">Elige un museo disponible con capacidad controlada.</p>
          </div>
        ...
        <form onSubmit={handleSubmit} className="grid gap-6 lg:grid-cols-[1.2fr_0.8fr]">
          ...
          <aside className="space-y-6 rounded-3xl border border-slate-800 bg-slate-900/90 p-8">
            ...
            <div className="rounded-3xl border border-slate-800 bg-slate-950/80 p-5">
              ...
              <p className="text-slate-300">Máximo 5 boletos por usuario. No se permite comida ni materiales peligrosos.</p>
            </div>
